...
export default function Terms() {
  return (
    <LegalPage title="Terms & Conditions" lastUpdated="11 July 2026">
      <p>
        These Terms & Conditions ("Terms") govern your access to and use of <strong>Suvee</strong>, a software-as-a-service
      ...
      <h2>1. Eligibility</h2>
      <p>You must be at least 18 years old and legally competent to contract in India, and — if signing up on behalf of a business — authorised to bind that business.</p>

      <h2>2. Account & Security</h2>
      <ul>
        <li>You are responsible for maintaining the confidentiality of your login credentials.</li>
        <li>You are responsible for all activity that occurs under your account.</li>
        <li>Notify us immediately at <a href="mailto:shrirajglobal@gmail.com">shrirajglobal@gmail.com</a> of any unauthorised use.</li>
      </ul>
      ...
      <ul>
        ...
        <li>All payments are processed through Razorpay. By paying, you also agree to Razorpay's terms.</li>
      </ul>

      <h2>4. Refunds</h2>
      <p>All fees are non-refundable. Please review our <a href="/refund">Cancellation & Refund Policy</a> for the complete details.</p>

      <h2>5. Acceptable Use</h2>
      <p>You agree not to:</p>
      <ul>
        <li>Upload unlawful, infringing, or harmful content.</li>
        <li>Attempt to reverse-engineer, decompile, or gain unauthorised access to the service.</li>
        <li>Use the service to send spam or violate the privacy of third parties.</li>
      ...
      <ul>
        ...
        <li><strong>AI providers</strong> — used only for optional AI features (card scanner, weekly report, natural-language assistant, partner search).</li>
      </ul>

      <h2>8. Service Availability</h2>
      <p>We aim for high availability but do not guarantee uninterrupted service. The service is provided on an "as is" and "as available" basis, without warranties of any kind, express or implied, to the maximum extent permitted by law.</p>
      ...
      <p>We may update the service and these Terms from time to time. Material changes will be notified by email or in-app notice at least 15 days before they take effect. Continued use after the effective date constitutes acceptance.</p>

      <h2>13. Governing Law & Jurisdiction</h2>
      <p>These Terms are governed by the laws of India. Any dispute arising out of or relating to these Terms shall be subject to the exclusive jurisdiction of the courts at <strong>[Registered city / state]</strong>.</p>

      <h2>14. Contact</h2>
      <p>Questions about these Terms: <a href="mailto:shrirajglobal@gmail.com">shrirajglobal@gmail.com</a>.</p>
    </LegalPage>
  );
}
